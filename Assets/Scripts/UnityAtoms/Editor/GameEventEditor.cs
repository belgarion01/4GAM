...
{
    public abstract class GameEventEditor<T, E> : ReferenceDataEditor
        where E : GameEvent<T>
    {
        protected T raiseEvent = default(T);
    ...
    public sealed class BoolEventEditor : GameEventEditor<bool, BoolEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<bool>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class ColliderEventEventEditor : GameEventEditor<Collider, ColliderEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<Collider>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class Collider2DEventEditor : GameEventEditor<Collider2D, Collider2DEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<Collider2D>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class ColorEventEditor : GameEventEditor<Color, ColorEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<Color>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class FloatEventEditor : GameEventEditor<float, FloatEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<float>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class GameObjectEventEditor : GameEventEditor<GameObject, GameObjectEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<GameObject>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class IntGameEventEditor : GameEventEditor<int, IntEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<int>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class Vector2EventEditor : GameEventEditor<Vector2, Vector2Event>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<Vector2>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class Vector3EventEditor : GameEventEditor<Vector3, Vector3Event>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<Vector3>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
    ...
    public sealed class StringEventEditor : GameEventEditor<string, StringEvent>
    {
        protected override VisualElement GetRaiseValueInput()
        {
            ...
            input.RegisterCallback<ChangeEvent<string>>((evt) => { raiseEvent = evt.newValue; });
            return input;
        }
    }
}
